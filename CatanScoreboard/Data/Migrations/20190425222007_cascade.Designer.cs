...
namespace CatanScoreboard.Data.Migrations
{
    ...
    [Migration("20190425222007_cascade")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CatanScoreboard.Models.FinishedGame", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("CatanScoreboard.Models.Player", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("CatanScoreboard.Models.PlayerScore", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("CatanScoreboard.Models.PlayerScore", b =>
                {
                    b.HasOne("CatanScoreboard.Models.FinishedGame", "FinishedGame")
                        .WithMany("PlayerScores")
                        .HasForeignKey("FinishedGameId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("CatanScoreboard.Models.Player", "Player")
